...
x3 = st.number_input("X3", value=200)
y3 = st.number_input("Y3", value=200)
x4 = st.number_input("X4", value=200)
...
if uploaded_image is not None:
    ...
    draw.polygon(polygon_coordinates, fill=(0, 0, 0, 50))  # RGBA color with 100 transparency
    ...
    if st.button("Submit"):
        ...
        send_api_request(polygon_coordinates, prompt, uploaded_image_path, base_model=base_model)